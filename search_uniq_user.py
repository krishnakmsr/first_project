...
def data_move_to_structre_collection(db_old, col_old,d1,d2, db_new, col_new,count_col):
  ...
  clientRead = MongoClient("192.168.29.53:27017",username='misbackend',password='Misbackend%40321')
  clientWrite = MongoClient("192.168.29.53:27017",username='misbackend',password='Misbackend%40321')
  ...
  count = collectionRead.count_documents(query)
    #print(count)
